...
export const Modal = ({ onClose, name, img, desc, price, item }) => {
  ...
  // Функция добавления товара в корзинку и закрытие модального окна

  function handleAddToCart(item, addIngredients) {
          ...
          >
            ...
            <div className={s.modal__right}>
              ...
              <div className={s.modal__addBtn}>
                <Button
                  variant="bigPrimary"
                  onClick={() => handleAddToCart(item, addIngredients)}
                >
